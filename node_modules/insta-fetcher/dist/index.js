...
class igApi {
     ...
     */
    constructor(session_id = '', storeCookie = true) {
         ...
         */
        this.accountInfo = (userID = this.session_id.split('%')[0]) => __awaiter(this, void 0, void 0, function* () {
            var _e, _f, _g;
            try {
        ...
        this._getReels = (ids) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (axios_1.default.isAxiosError(error)) {
                    if (((_v = error.response) === null || _v === void 0 ? void 0 : _v.status) == 404) {
                        throw new Error('Post Not Found');
                    }
                    else if (((_w = error.response) === null || _w === void 0 ? void 0 : _w.status) == 403) {
                        throw new Error('Forbidden, try set cookie first');
                    }
                    else if (((_x = error.response) === null || _x === void 0 ? void 0 : _x.status) == 401) {
                        throw new Error('Unauthorized, try set cookie first');
                    }
                    else {
                        throw error.toJSON();
